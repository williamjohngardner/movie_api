    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Movie')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Rater')),
            ],
        ),
    ]
